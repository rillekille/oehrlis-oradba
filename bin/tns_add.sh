...
function Usage() {
  ...
  Add options:
    ...
    -A                  Create an Oracle Net Service alias rather a full description
...
EOI
            ...
            echo "WARN : Net Service Name $current_cn does exists in $current_basedn. Enable force mode to modify it."
        fi
    fi
done
