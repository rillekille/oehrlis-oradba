...
--------------------------------------------------------------------------------
--  Name......: isenc_tde_pdbiso_force.sql
...
--              enable TDE and it also includes restart of the pdb. It explicitly
--              discard lost masterkey handles.
--
--              The following steps are performed:
--              - csenc_swkeystore.sql  create and configure software keystore
--              - idenc_lostkey.sql     to discard lost masterkey handles
...
-- start to spool
SPOOL isenc_tde_pdbiso_force.log
